...
The reference interval inserts a numbered reference hand after every N stimulus pairs. The default interval of 10 adds `REF_01` after pair 10, `REF_02` after pair 20, and so on. Set the interval to `0` to disable reference hands. Reference drawings are cached and exported like stimulus drawings.
